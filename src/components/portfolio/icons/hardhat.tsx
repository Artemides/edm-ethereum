...
export const Hardhat = ({ height, width }: HardhatProps) => {
  return (
    <svg
    ...
    >
      ...
      <path d="M127.99 98.893V92.68c0-1.155-1.943-2.256-5.43-3.249l.084-7.732a57.71 57.71 0 0 0-10.588-33.296A58.573 58.573 0 0 0 84.121 27.13l-.25-1.55a4.419 4.419 0 0 0-1.046-2.238 4.483 4.483 0 0 0-2.092-1.337 59.402 59.402 0 0 0-33.167 0c-.814.239-1.54.7-2.1 1.335a4.398 4.398 0 0 0-1.051 2.237l-.24 1.445a58.588 58.588 0 0 0-28.13 21.256A57.734 57.734 0 0 0 5.374 81.697v7.765c-3.439.99-5.356 2.079-5.356 3.226V98.9a1.514 1.514 0 0 0 .224 1.047 15.017 15.017 0 0 1 5.766-2.604 113.37 113.37 0 0 1 16.174-2.684 10.906 10.906 0 0 1 8.487 2.712 22.967 22.967 0 0 0 15.42 5.933h35.834a22.95 22.95 0 0 0 15.417-5.938 10.914 10.914 0 0 1 8.489-2.743A114.1 114.1 0 0 1 122 97.297a13.498 13.498 0 0 1 5.466 2.373c.09.09.2.17.277.254a1.54 1.54 0 0 0 .246-1.031z" />
      <path
        fill="url(#a)"
