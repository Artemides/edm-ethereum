export const highlightSol = (code: string) => {
  ...
  return lines.map((line, index) => {
    ...
    const highlightedLine = line.replace(
      /(\/\/[^\n]*|\/\*[\s\S]*?\*\/|\b(Contract|Uniswap|Oracle|function|require|uint|int|address|bool|mapping|string|public|private|view|returns|memory|storage)\b|\d+|"([^"]*)"|'([^']*)'|([a-zA-Z_][a-zA-Z0-9_]*)(?=\s*\()|\b([a-zA-Z_][a-zA-Z0-9_]*)\b(?!\s*\())/g,
